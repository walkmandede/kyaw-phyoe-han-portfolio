...
class BsBottomSheetMultiplePicker extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ValueNotifier<List<BottomSheetPickerModel>> selectedData = ValueNotifier([...preSelectedData]);
                        ...
                        children: [
                                                  ...
                                                  onPressed: () {
                                                    ...
                                                    if(!xSelected){
                                                      ...
                                                      temp.removeWhere((element) {
                                                       return  element.id == eachData.id;
                                                      },);
                                                    }
                                                    selectedData.value = temp;
                                                  },
                                                  icon: Icon(
                                                    xSelected?Icons.check_box_rounded:Icons.check_box_outline_blank_rounded,
                                                    color: xSelected?theme.primary:theme.disableColor,
                                                  )
                                              ),
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              TextButton(onPressed: () {
                                selectedData.value = [];
                              }, child: Text("ရှင်းရန်",style: TextStyle(color: theme.redDanger,fontSize: AppConstants.fontSizeL),)),
                              5.widthBox(),
                              SizedBox(
