...
class ThemeController extends GetxController{
  ...
  final ValueNotifier<EnumAppTheme> _currentAppThemEnum = ValueNotifier(EnumAppTheme.dark);
  ...
  Future<void> initLoad() async{
    ...
    try{
      ...
      if(savedTheme!=null){
        _currentAppThemEnum.value = EnumAppTheme.values.where((element) => element.name == savedTheme,).firstOrNull??EnumAppTheme.dark;
      }
    }
    catch(e){
      //
  ...
  void updateTheme() async{
    ...
    SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
    sharedPreferences.setString(SpKeys.enumCurrentTheme, _currentAppThemEnum.value.name);
  }
